...
func main() {
	...
	//	Here's the actual syscall.Exec call. If this call is successful, the execution of our process will end here and be replaced by
...
//	Note that Go does not offer a classic Unix fork function. Usually this isn't an issue though, since starting
//	go routines, spawning processes, and exec'ing processes cover most use cases for fork.
