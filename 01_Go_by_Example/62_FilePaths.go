...
//	The filepath package provides functions to parse and construct filepaths in a way
...
func main() {
	...
	//	You should always use Join instead of concatenating /s or \s manually. In addition to portability,
	...
	//	Some filenames have extensions following a dot. We can split the extension out of such names with Ext
