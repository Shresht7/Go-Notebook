...
func main() {
	...
	//	select will take the <-messages case with that value, If not it will immediately take the default case
	select {
	case msg := <-messages:
	...
	//	We can use multiple cases above the default clause to implement a multi-way blocking select.
